...
convlstm1 = ConvLSTM2D(10,3,3,border_mode='same', W_regularizer=l1(wr), init='lecun_uniform')
conv_l1 = convlstm1(frame_in)
Econv_l1 = ELU()(conv_l1)
pool_l1 = MaxPooling2D(pool_size=(2,2))(Econv_l1)

convlstm2 = ConvLSTM2D(10,3,3,border_mode='same', W_regularizer=l1(wr), init='lecun_uniform')
conv_l2 = convlstm2(pool_l1)
Econv_l2 = ELU()(conv_l2)
pool_l2 = MaxPooling2D(pool_size=(2,2))(Econv_l2)
drop_l2 = Dropout(dp)(pool_l2)

convlstm3 = ConvLSTM2D(16,3,3,border_mode='same', W_regularizer=l1(wr), init='lecun_uniform')
conv_l3 = convlstm3(drop_l2)
